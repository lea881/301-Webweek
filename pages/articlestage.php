<?php 
    ...
    if(isset($_GET['id'])){
        ...
        $requeteAnim = "SELECT animateur.* FROM animateur, encadre WHERE animateur.idAnimateur = encadre.idAnimateur AND encadre.idStage = " . $stageChoisi->getId();
    ...
    <main class="articlestage">
        ...
        <div>
            ...
            <!--Afficher une seule date si le debut et la fin sont le meme jour-->
                <?php 
                    if ($stageChoisi->getDateDebut()===$stageChoisi->getDateFin()) {
                ?>
                        <p>
                            <strong>Date :</strong>
                        ...
                        <p>
                            ...
                            <?php echo $stageChoisi->getHoraires(); ?>
                        </p>
                        <p>
                            <strong>Tarif :</strong>
                            <?php echo $stageChoisi->getTarif(); ?> 
                            €
                        </p>
                        <p>
                            <strong>Lieu : </strong>
